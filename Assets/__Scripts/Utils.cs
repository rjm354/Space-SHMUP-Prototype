...
public class Utils : MonoBehaviour {
        ...
        public static Bounds BoundsUnion(Bounds b0, Bounds b1)
    {
        ...
        //Stetch b0 to include the b1.min and b1.max
    ...
    //This function is used by camBounds to set _camBounds and can aso be
    //called directly.
    ...
    public static Vector3 BoundsInBoundsCheck(Bounds bigB, Bounds lilB, BoundsTest test = BoundsTest.onScreen)
    {
        ...
        switch(test)
        {
            ...
            //The offScreen test determines what off whould have to be applied to
            //keep all off lilB inside bigB
