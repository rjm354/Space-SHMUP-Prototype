...
//Titems marked [NI] below are Not Implemented in this book
...
public class Weapon : MonoBehaviour
{
    ...
    public void SetType(WeaponType wt)
    {
        ...
        lastShot = 0; //You can always fire immediately aftr _type is set.
    }
    public void Fire()
    {
        ...
        //If is hasn't been enough time between shots, return
