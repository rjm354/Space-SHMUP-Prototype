...
public class Enemy_4 : Enemy
{
    ...
    //move to. Once it has arrived, it will pick another point and
    ...
    //This will completely override the OnCollisionEnter that is part of Enemy.cs
    //Because of the way that MonoBehaviour declared common Unity functions
    ...
    void OnCollisionEnter(Collision coll)
    {
        ...
        switch(other.tag)
        {
            case "ProjectileHero":
                ...
                //The Collision coll has contacts[], an array o ContactPoints
                ...
                bool allDestroyed = true; //Assume is destroyed
                foreach(Part prt in parts)
                {
    ...
    bool Destroyed(Part prt)
    {
        ...
        {
            return (true);  //returns true (meaning yes, it was destroyed
        }
        //Returns the result of the comaprison: prt.health <= 0
